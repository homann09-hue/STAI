...
export const PROVIDER_DEFINITIONS: readonly ProviderDefinition[] = [
  ...
  },
  {
    ...
    name: "Binance",
    adapterStatus: "implemented",
    capabilities: ["quote", "quote_batch", "stream_quotes", "stream_trades"],
    assetClasses: ["crypto"],
    configurationEnv: [],
...
> = {
  ...
  stream_quotes: ["alpaca", "coinbase", "binance", "twelve_data", "databento"],
  stream_trades: ["alpaca", "finnhub", "binance"],
